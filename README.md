...
- [ ] Describe Middleware?
      Middleware is some functionality that is executed between when a request is made and before it completes . It is responsible for performing checks or modifications of the request and deciding whether to continue the action or ending the request.

- [ ] Describe a Resource?
      A resource is the distinct piece of data that is being manipulated by the API.

- [ ] What can the API return to help clients know if a request was successful?
      Sucess status codes such as 200 0r 201 along with JSON messages that tell the clients that their action has been successful

- [ ] How can we partition our application into sub-applications?
      By separating distinct resources into routes and merging them in the app entry point.
